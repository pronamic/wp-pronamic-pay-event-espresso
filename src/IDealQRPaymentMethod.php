...
/**
 * Title: WordPress pay Event Espresso 4.6+ iDEAL QR payment method
 * Description:
 ...
 * @since   unreleased
 */
class IDealQRPaymentMethod extends PaymentMethod {
	/**
	 * Payment method.
	 *
	 * @since unreleased
	...
	public function __construct( $pm_instance = null ) {
		...
		$this->_default_button_url = plugins_url( 'images/ideal-qr/ee-4-icon.png', Plugin::$file );
