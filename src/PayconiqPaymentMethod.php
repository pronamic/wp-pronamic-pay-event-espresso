...
/**
 * Title: WordPress pay Event Espresso Payconiq payment method
 * Description:
 * Copyright: 2005-2019 Pronamic
 * Company: Pronamic
 *
 ...
 * @since   2.0.0
 */
class PayconiqPaymentMethod extends PaymentMethod {
	/**
	 * Payment method.
	 *
	 * @since 2.0.0
