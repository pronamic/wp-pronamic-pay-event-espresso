...
class ActionScheduler_AdminView extends ActionScheduler_AdminView_Deprecated {
	...
	public function init() {
		if ( is_admin() && ( ! defined( 'DOING_AJAX' ) || false == DOING_AJAX ) ) {
			...
			if ( class_exists( 'WooCommerce' ) ) {
				add_action( 'woocommerce_admin_status_content_action-scheduler', [ $this, 'render_admin_ui' ] );
				add_action( 'woocommerce_system_status_report', [ $this, 'system_status_report' ] );
				add_filter( 'woocommerce_admin_status_tabs', [ $this, 'register_system_status_tab' ] );
			}

			add_action( 'admin_menu', [ $this, 'register_menu' ] );
			add_action( 'admin_notices', [ $this, 'maybe_check_pastdue_actions' ] );
	...
	public function register_menu() {
		...
		add_action( 'load-' . $hook_suffix, [ $this, 'process_admin_ui' ] );
	}
