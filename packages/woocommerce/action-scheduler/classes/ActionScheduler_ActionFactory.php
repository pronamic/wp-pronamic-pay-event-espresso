...
class ActionScheduler_ActionFactory {
	 ...
	 */
	public function get_stored_action( $status, $hook, array $args = [], ActionScheduler_Schedule $schedule = null, $group = '' ) {
	 ...
	 */
	public function async( $hook, $args = [], $group = '' ) {
	 ...
	 * @return int The ID of the stored action.
	 */
	public function async_unique( $hook, $args = [], $group = '', $unique = true ) {
	 ...
	 * @return int The ID of the stored action.
	 */
	public function single( $hook, $args = [], $when = null, $group = '' ) {
	 ...
	 * @return int The ID of the stored action.
	 */
	public function single_unique( $hook, $args = [], $when = null, $group = '', $unique = true ) {
	 ...
	 * @return int The ID of the stored action.
	 */
	public function recurring( $hook, $args = [], $first = null, $interval = null, $group = '' ) {
	 ...
	 * @return int The ID of the stored action.
	 */
	public function recurring_unique( $hook, $args = [], $first = null, $interval = null, $group = '', $unique = true ) {
		if ( empty( $interval ) ) {
	 ...
	 * @return int The ID of the stored action.
	 */
	public function cron( $hook, $args = [], $base_timestamp = null, $schedule = null, $group = '' ) {
	 ...
	 * @return int The ID of the stored action.
	 **/
	public function cron_unique( $hook, $args = [], $base_timestamp = null, $schedule = null, $group = '', $unique = true ) {
		if ( empty( $schedule ) ) {
