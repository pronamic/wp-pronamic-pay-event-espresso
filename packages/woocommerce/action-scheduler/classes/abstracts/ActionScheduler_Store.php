...
abstract class ActionScheduler_Store extends ActionScheduler_Store_Deprecated {
	 ...
	 */
	abstract public function query_actions( $query = [], $query_type = 'select' );
	 ...
	 */
	abstract public function stake_claim( $max_actions = 10, DateTime $before_date = null, $hooks = [], $group = '' );
	...
	protected function validate_sql_comparator( $comparison_operator ) {
		if ( in_array( $comparison_operator, [ '!=', '>', '>=', '<', '<=', '=' ] ) ) {
