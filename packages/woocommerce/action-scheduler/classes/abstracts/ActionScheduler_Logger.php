...
abstract class ActionScheduler_Logger {
	...
	public function init() {
		...
		add_action( 'action_scheduler_begin_execute', [ $this, 'log_started_action' ], 10, 2 );
		add_action( 'action_scheduler_after_execute', [ $this, 'log_completed_action' ], 10, 3 );
		add_action( 'action_scheduler_failed_execution', [ $this, 'log_failed_action' ], 10, 3 );
		...
		add_action( 'action_scheduler_execution_ignored', [ $this, 'log_ignored_action' ], 10, 2 );
		add_action( 'action_scheduler_failed_fetch_action', [ $this, 'log_failed_fetch_action' ], 10, 2 );
		add_action( 'action_scheduler_failed_to_schedule_next_instance', [ $this, 'log_failed_schedule_next_instance' ], 10, 2 );
		add_action( 'action_scheduler_bulk_cancel_actions', [ $this, 'bulk_log_cancel_actions' ], 10, 1 );
	}

	public function hook_stored_action() {
		add_action( 'action_scheduler_stored_action', [ $this, 'log_stored_action' ] );
	}

	public function unhook_stored_action() {
		remove_action( 'action_scheduler_stored_action', [ $this, 'log_stored_action' ] );
	}
