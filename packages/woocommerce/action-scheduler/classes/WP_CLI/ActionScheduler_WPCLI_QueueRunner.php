...
class ActionScheduler_WPCLI_QueueRunner extends ActionScheduler_Abstract_QueueRunner {
	 ...
	 */
	public function setup( $batch_size, $hooks = [], $group = '', $force = false ) {
		$this->run_cleanup();
		$this->add_hooks();
	...
	protected function add_hooks() {
		add_action( 'action_scheduler_before_execute', [ $this, 'before_execute' ] );
		add_action( 'action_scheduler_after_execute', [ $this, 'after_execute' ], 10, 2 );
		add_action( 'action_scheduler_failed_execution', [ $this, 'action_failed' ], 10, 2 );
	}
