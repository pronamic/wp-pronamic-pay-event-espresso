 ...
 */
function wc_schedule_single_action( $timestamp, $hook, $args = [], $group = '' ) {
 ...
 * @return string The job ID
 */
function wc_schedule_recurring_action( $timestamp, $interval_in_seconds, $hook, $args = [], $group = '' ) {
 ...
 * @return string The job ID
 */
function wc_schedule_cron_action( $timestamp, $schedule, $hook, $args = [], $group = '' ) {
 ...
 * @deprecated 2.1.0
 */
function wc_unschedule_action( $hook, $args = [], $group = '' ) {
 ...
 * @return array
 */
function wc_get_scheduled_actions( $args = [], $return_format = OBJECT ) {
